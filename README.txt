...
Jekyll is now used to generate a static version of the website, ./lib/
massage_importer.rb was written to import data into the new jekyll site 
from the ./lib/kwmassage_export.xml file.
***
